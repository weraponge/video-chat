...
def write_top_bar():
    ...
    with col2:
        ...
        description = """
        Provide the URL for the video to summarize and click Enter. 
        <br>
         <b>
        """
...
def handle_input():
    ...
    if len(st.session_state.questions)==0:
        # Get video id from youtube url # https://www.youtube.com/watch?v=kNrvc0hkPuE
...
st.markdown("---")
input = st.text_input(
    "Follow up questions here..", key="input", on_change=handle_input
)
